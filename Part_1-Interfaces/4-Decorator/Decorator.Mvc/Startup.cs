...
using Decorator.NoaaProvider;
using Decorator.OpenWeatherApiProvider;
using Decorator.WeatherProvider;
using Decorator.ZipCodeService;
...
namespace Decorator.Mvc
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.Decorate<IWeatherClient, CachingDecorator>();
