...
{
    public class BetterPasswordRulevalidatorTests
    {

        internal IPasswordChecker GetPasswordRuleValidator()
        {
            BetterPasswordRuleValidator validator = new BetterPasswordRuleValidator();
